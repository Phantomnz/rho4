/*
 * ===================================================================
 * ELEC Lab p4: Closed-Loop PID Voltage Controller
 * ===================================================================
 *
 * This program merges the PWM DAC from 'dac.c' and the ADC
 * sensor from 'adc.c' to create a full PID (Proportional,
...
// --- Gains (THESE ARE WHAT YOU WILL TUNE) ---
// Start with KP enabled and the others at 0.0
...
/* ==================================================================
 * HARDWARE FUNCTIONS (from dac.c and adc.c)
 * ==================================================================
 */
...
int main(void) {
    ...
    for (;;) {
        ...
        // --- 8. DEBUG & WAIT ---
        // Print values to serial. This is vital for tuning!
